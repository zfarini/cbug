...
function binary() -> Node*  (185)


function parse_type() -> Type*  (186)


function parse() -> Node*  (187)


function function() -> Node*  (188)


function decl() -> Node*  (189)


function statement() -> Node*  (190)


function expr() -> Node*  (191)


function assign() -> Node*  (192)


function conditional() -> Node*  (193)


function logical_or() -> Node*  (194)


function logical_and() -> Node*  (195)


function equality() -> Node*  (196)


function relational() -> Node*  (197)


function add() -> Node*  (198)


function mul() -> Node*  (199)


function cast() -> Node*  (200)


function unary() -> Node*  (201)


function postfix() -> Node*  (202)


function primary() -> Node*  (203)
...
function fopen() -> FILE*  (224)


function new_node() -> Node*  (225)
...
function token_type_name(int type) -> char*  (284)
{
    if (type == 256)
        return "int";
    else if (type == 257)
...
function new_temp_token(int type) -> Token*  (318)
{
...
function get_backspace_char(char c) -> char  (327)
{
    if (((int)c) == 110)
        return 10;
...
function add_multi_char_token(char* name, int type) -> void  (342)
{
...
function add_keyword(char* name, int type) -> void  (349)
{
...
function tokenize(char* s) -> Token*  (356)
{
...
function align(int n, int a) -> int  (541)
{
    return n + a - 1 / a * a;
}


function find(char* s, char c) -> char*  (546)
{
    int i;
    i = 0
    while (*(s + i))
...
function leave_scope() -> void  (575)
{
    curr_scope = curr_scope->parent
}


function new_type(int t) -> Type*  (580)
{
...
function types_are_equal(Type* t1, Type* t2) -> int  (597)
{
    if (!(t1) || !(t2))
        return 0;
...
function add_func(char* name, Type* ret_type) -> Func*  (612)
{
...
function find_func(char* name) -> Func*  (620)
{
...
function find_var(char* name) -> Var*  (630)
{
...
function new_var(Type* type, char* name) -> Var*  (654)
{
...
function skip(int type) -> void  (685)
{
...
function is_typename(Token* tok) -> int  (692)
{
...
function find_binary_op_type(Type* t1, Type* t2) -> Type*  (716)
{
...
function strjoin(char* s1, char* s2) -> char*  (726)
{
    int l1 = strlen(s1);
    int l2 = strlen(s2);
...
function get_type_str(Type* type) -> char*  (737)
{
    if (type->t == 7)
    {
        return type->name;
...
function add_type(Node* node) -> Type*  (762)


function implicit_cast(Node** node, Type* type) -> void  (764)
{
    add_type(*(node))
...
function find_common_type(Type* t1, Type* t2) -> Type*  (775)
{
    if (t1->ptr_to)
        return t1;
...
function add_type(Node* node) -> Type*  (790)
{
    Type *t = type_void;
    if (!(node))
        return t;
...
function parse(char* s) -> Node*  (921)
{
    ...
    for (int i = 0; i < types_declared_count ;i++)
    {
        ...
        for (int j = 0; j < t->field_count ;j++)
        {
            ...
            if (*(t->field_type + j)->size > align)
                align = *(t->field_type + j)->size
...
function find_type(char* name) -> Type*  (1094)
{
    for (int i = 0; i < types_declared_count ;i++)
    {
...
function parse_base_type() -> Type*  (1104)
{
...
function statement_or_decl() -> Node*  (1228)
{
    if (is_typename(&(*(tokens + ct))))
    {
        Node *node = decl(0);
...
function decl(int is_struct) -> Node*  (1239)
{
...
function conditional() -> Node*  (1539)
{
...
function logical_or() -> Node*  (1555)
{
    return binary(logical_and, 259, -(1));
}


function logical_and() -> Node*  (1560)
{
    return binary(equality, 258, -(1));
}


function equality() -> Node*  (1565)
{
    return binary(relational, 260, 261, -(1));
}


function relational() -> Node*  (1570)
{
    return binary(add, 60, 62, 262, 263, -(1));
}


function add() -> Node*  (1575)
{
    return binary(mul, 43, 45, -(1));
}


function mul() -> Node*  (1580)
{
    return binary(cast, 42, 47, 37, -(1));
}


function cast() -> Node*  (1585)
{
...
function get_inst_suffix(int size) -> char*  (1845)
{
    if (size == 1)
        return "b";
    else if (size == 2)
...
function get_size_name(int size) -> char*  (1858)
{
    if (size == 1)
        return "byte";
    else if (size == 2)
...
function log2_int(int x) -> int  (1871)
{
    int y = 0;
    while (x > 1)
    {
...
function get_register_by_size(char* reg, int size) -> char*  (1882)
{
...
function add_string_lit(char* s) -> int  (1917)
{
...
function push(char* reg) -> void  (1937)
{
...
function pop(char* reg) -> void  (1943)
{
    stack_size -= stack_size - 8
...
function gen(Node* node) -> void  (1950)
{
    if (!(node) || node->type == 0)
        return (NULL);
...
function print(Node* node) -> void  (2625)
{
    if (!(node))
        return (NULL);
...
function read_entire_file(char* name) -> char*  (2824)
{
    char *buffer = ((char*)0);
    long length;
